...
def k_fold(out):
    ...
    print "Initializing K-fold cross validation split dataset"
    ...
    for k in range(1,6):
        ...
        trainset.tofile(path + "trainset_%d.bin" % k)    
        trainset.tofile(path + "testset_%d.bin" % k)    
        
        print 
        print "Files of K=%d 'trainset_%d.bin' and 'testset_%d.bin' write in path: " % (k,k,k)
        print path
