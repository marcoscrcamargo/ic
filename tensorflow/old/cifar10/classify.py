...
path = './../DBIM/Originals/2/6.jpg'
# path = './../DBIM/NewBD/0/6.jpg'
# path = './../DBIM/NewBD/1/66.jpg'
# path = './../DBIM/NewBD/2/292.jpg'
...
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', mypath + '/cifar10_train',
                           """Directory where to read model checkpoints.""")
